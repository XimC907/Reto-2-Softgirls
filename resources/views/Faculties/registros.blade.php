...
<body>
    <h1 style="text-align: center">Listado Facultades</h1>
    <div class="container">
        <table class="table table-dark table-striped-columns">
            <div style="text-align:right">
            <a class="btn btn-info">Añadir Facultad</a>
        </div>
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <tr>
                <td style="text-align: center; vertical-align: middle" scope="row">{{$f->faculty_id}}</td>
                <td style="text-align: center; vertical-align: middle">{{$f->faculty_name}}</td>
                <td>
